...
<?php
    function listar_garantes( $conexion)
    {
        

            $sql = "select * from DBA_TP.vista_garantes";
			$filas = 0;
        ...
        while ($row = oci_fetch_array($stmt, OCI_ASSOC+OCI_RETURN_NULLS))  
        {
            ...
            echo "</tr>";
                ...
                // Mostrar el número de registros:
                 echo "<p>(".oci_num_rows($stmt).") garante(s) encontrado(s)</p>";
...
<?php
echo "<p/>Listado de Garantes: <br/>";
$con = conectar_Oracle($user,$pas);
$listado = listar_garantes( $con);
